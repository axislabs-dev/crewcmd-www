...
const rows = [
  ...
  { feature: 'Centralized action items inbox', without: false, with: true },
  { feature: 'BYO OpenClaw runtime', without: false, with: true },
  { feature: 'Visual team org chart', without: false, with: true },
  { feature: 'Agent budgets & guardrails', without: false, with: true },
  { feature: 'One-click agent team import', without: false, with: true },
